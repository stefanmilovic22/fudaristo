    ...
    return (
      <Shell>
        <p className="text-slate-400">
          Još nema obračunatih poena. Top liste se pune čim admin obračuna prvo kolo („Obračunaj
          poene” u admin panelu).
        </p>
      </Shell>
    );
  }
...
function Shell({
  ...
  return (
    <div>
      <h2 className="font-display text-2xl mb-1">Statistike</h2>
      <p className="text-slate-400 text-sm mb-6">
        {lastGameweek
          ? `Zaključno sa ${lastGameweek}. kolom.`
          : "Top liste grčke Super lige kroz fantasy poene."}
      </p>
      {children}
    </div>
  );
